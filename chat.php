...
<!-- Mirrored from finder.createx.studio/car-finder-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Nov 2022 20:35:18 GMT -->
      ...
      <section class="container pb-3 pb-sm-4 pb-md-5">
        <div class="row align-items-center pb-5">
          <div class="col-md-7 col-lg-6 col-xl-5 offset-xl-1 text-center text-md-start mb-4 mb-md-0">
            <h2 class="text-light mb-4">Miaouuuuuuuuuuuuuu !..</h2><br>
            <h2 class="text-light mb-4">Votre personnalité est : Mr Chat</h2>
            <p class="fs-lg text-light opacity-70 mb-md-5">Peeetit petit petit. Allez approche mon petit Coin-coin...</p>

          </div>
          <div class="col-md-5 col-lg-6"><img class="d-block mx-auto" src="img/car-finder/home/Mr._Chat.webp" width="460" alt="Mobile App"></div>
        </div>
      </section>
...
<!-- Mirrored from finder.createx.studio/car-finder-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Nov 2022 20:55:07 GMT -->
</html>