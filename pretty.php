      ...
      <section class="container pb-3 pb-sm-4 pb-md-5">
        <div class="row align-items-center pb-5">
          <div class="col-md-7 col-lg-6 col-xl-5 offset-xl-1 text-center text-md-start mb-4 mb-md-0">
            <h2 class="text-light mb-4">Ouais ouais ouais! Double ouais!</h2><br>
            <h2 class="text-light mb-4">Votre personnalité est : Pretty</h2>
            <p class="fs-lg text-light opacity-70 mb-md-5">Ohhhh Mr Chat .....</p>

          </div>
          <div class="col-md-5 col-lg-6"><img class="d-block mx-auto" src="img/car-finder/home/Pretty.png" width="460" alt="Mobile App"></div>
        </div>
      </section>
